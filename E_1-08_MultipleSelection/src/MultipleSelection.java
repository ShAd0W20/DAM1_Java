...
public class MultipleSelection {
	...
	public static void main(String[] args) {
		/*
		 Feu un programa que us pregunti quina nota numèrica heu tret en el mòdul i us digui la nota literal que us correspon.
		...
		El programa demana la nota del mòdul per teclat
		...
		*/
		...
		System.out.println("Quina nota has tret al mòdul?");
		...
		if(nota < 5) {
			System.out.println("Has tret una nota de " + nota + " que correspon amb un suspès");
		} else if (nota < 7) {
			...
			System.out.println("El valot introuit no es vàlid");
		}
